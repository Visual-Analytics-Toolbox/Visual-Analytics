...
CMD ["uv", "run", "--no-sync", "opentelemetry-instrument", "gunicorn", "core.wsgi:application", "--workers=2", "--threads=4", "--worker-class", "gthread", "--bind", "0.0.0.0:8000", "--access-logfile", "-", "--error-logfile", "-"]

...
class Annotation(models.Model):
    ...
    tags = models.ManyToManyField(
        Tag, through="AnnotationTag", related_name="annotations_set"
    )
...
class AnnotationTag(models.Model):
    annotation = models.ForeignKey(
        Annotation, on_delete=models.CASCADE, related_name="tag_links"
    )
    tag = models.ForeignKey(
        Tag, on_delete=models.CASCADE, related_name="annotation_links"
    )

...
def create_detailed_statistics_plot(robot_stats, output_folder):
    ...
    ax1.set_xticks(robot_numbers)
    ax1.set_xticklabels([f'Robot {r}' for r in robot_numbers])
    ...
    ax2.set_xticks(robot_numbers)
    ax2.set_xticklabels([f'Robot {r}' for r in robot_numbers])
